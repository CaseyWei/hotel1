...
<form method="post" action="A">
  <table width="252" border="1">
    ...
    <tr>
      <td width="71">用户名：</td>
      <td width="165"><input type="text" name="uname" readonly="readonly" value="${user.id}"/></input><!--<span id="note"></span></td>-->
    </tr>
    <tr>
      <td>原密码：</td>
      <td><input type="password" name="upwd" value="${user.apwd}"/></input><!--<span id="note1"></span></td>-->
    </tr>
