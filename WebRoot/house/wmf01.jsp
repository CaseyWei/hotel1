...
<html> 
  ...
  <body  background="<%=basePath%>image/r.jpg">
		<div id="big">
   	  		...
   	  		<div id="top">
   			<img alt="客房" src="<%=basePath%>houseimg/hhd.jpg">
   		</div>
   		<br/>
   		<hr>
   		<div id="01">
		...
		<ul class="list_room">
			...
			<div class="list_room_tj_row">
                <ul class="list_room_w90">特惠大床房</ul>
                ...
                <a class="yuding list_room_tj_yd" href="<%=basePath%>YDCheckLoginSvl" hotelid="M37102" roomid="SKS" loginMark="false">预订</a>
                </ul>
            </div>
            <hr width="680"/>
            <div></div>
